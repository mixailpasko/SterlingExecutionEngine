	...
	namespace ExecutionEngine
	{
	 ...
	 { 
		 ...
		 */	
			 ...
			 //std::string xml_str( ws.begin(), ws.end() );
	 ...
	 void SterlingEventSink::OrderConfirm(Serializable::CustROrder_ser& obj)
	 {
		 ...
		 LOG4CPLUS_INFO(ExecEngine::EngineLogger, "EVENT : ORDER-CONFIRM OCCURED"); 
		 ohandle.OrderConfirmEvent(obj);
	 }
	 ...
	 void SterlingEventSink::OrderRejected(Serializable::CustROrder_ser& obj)
	 {
		 ...
		 ohandle.OrderRejectedEvent(obj);
	 }
	 ...
	 void SterlingEventSink::OrderUpdate(Serializable::CustROrder_ser& obj)
	 {
		 ...
		 ohandle.OrderUpdateEvent(obj);
	 }

	 void SterlingEventSink::TradeUpdate(Framework::ExecutionEngine::TradeUpdate& tu)
	 {
